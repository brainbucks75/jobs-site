...
function getOrderWordsQuestions(){
  return JSON.parse(fs.readFileSync('orderwordsQuestions.json', 'utf8'));
}
/* =========================
...
<script>
const questions = ${JSON.stringify(getOrderWordsQuestions())};
...
window.pickLetter = function(el, letter){
